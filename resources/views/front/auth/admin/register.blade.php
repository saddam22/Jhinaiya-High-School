           ...
           <form method="POST" action="{{ route('register') }}" class="px-lg-4">
              ...
              <div class="input-group input-group--focus mb-3">
                <div class="input-group-prepend">
                  <span for="name" class="input-group-text bg-white ti-user"></span>
                </div>
                <input type="text" id="name" name="name" class="form-control border-left-0 pl-0 @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Enter Full Name" required autocomplete="name" autofocus> 
              </div>
              <div class="input-group input-group--focus mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text bg-white ti-email"></span>
                </div>
                <input type="email" id="email" name="email" class="form-control border-left-0 pl-0 @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Enter Email" required autocomplete="email" autofocus>
              </div>
              <div class="input-group input-group--focus mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text bg-white ti-lock"></span>
                </div>
                <input type="password" id="password" name="password" class="form-control border-left-0 pl-0 @error('password') is-invalid @enderror" value="{{ old('password') }}" placeholder="Enter Password" required autocomplete="password" autofocus>
              </div>
               <div class="input-group input-group--focus mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text bg-white ti-lock"></span>
                </div>
                <input type="password" id="password-confirm" name="password_confirmation" class="form-control" placeholder="Enter Password" required autocomplete="new-password" autofocus>
              </div>
              <div class="my-4">
              ...
              <button class="btn btn-block btn-primary">{{ __('Register') }}</button>
