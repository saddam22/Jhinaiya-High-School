...
<div class="mdc-card">
{!! Form::open(['url'=>'/add/learn_share', 'method'=>'post', 'role'=>'form']) !!}
...
<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
  ...
  <input class="mdc-text-field__input" id="menu" name="learn_share_title">
...
<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
  <i class="material-icons mdc-text-field__icon">favorite</i>
  <textarea rows="10" cols="5" class="mdc-text-field__input" name="learn_share_description" placeholder="Enter Upcoming Events"></textarea>
  <div class="mdc-notched-outline">
    <div class="mdc-notched-outline__leading"></div>
    <div class="mdc-notched-outline__notch">
