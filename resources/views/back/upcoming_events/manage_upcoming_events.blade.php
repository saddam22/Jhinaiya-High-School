...
<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Manage Upcoming Events</h6>
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                      	<?php $i = 0 ?>
                      	@foreach($upcoming_events_message as $upcomingEvents)
                        <tr>
                          <td>{{ ++$i }}</td>
                          <td>{{ $upcomingEvents->upcoming_events_title }}</td>
                          <td>{{ $upcomingEvents->upcoming_events_address }}</td>
                          <td>
