...
<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Manage Student Review</h6>
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                      	<?php $i = 0 ?>
                      	@foreach($student_review_message as $student_reviews)
                        <tr>
                          <td>{{ ++$i }}</td>
                          <td>{{ $student_reviews->student_review_title }}</td>
                          <td>{{ $student_reviews->student_review_description }}</td>
                          <td>
