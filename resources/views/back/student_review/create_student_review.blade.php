...
<div class="mdc-card">
{!! Form::open(['url'=>'/add/students_review', 'method'=>'post', 'role'=>'form']) !!}
...
<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
  ...
  <input class="mdc-text-field__input" id="menu" name="student_review_title">
...
<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
  <i class="material-icons mdc-text-field__icon">favorite</i>
  <textarea rows="10" cols="5" class="mdc-text-field__input" name="student_review_description" placeholder="Enter Upcoming Events"></textarea>
  <div class="mdc-notched-outline">
    <div class="mdc-notched-outline__leading"></div>
    <div class="mdc-notched-outline__notch">
