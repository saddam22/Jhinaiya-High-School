...
<div class="mdc-card">
{!! Form::open(['url'=>'/add/practice_wish', 'method'=>'post', 'role'=>'form']) !!}
<h6 class="card-title">Add Learn & Share</h6>
<div class="template-demo">
<div class="mdc-layout-grid__inner">
<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
  <i class="material-icons mdc-text-field__icon">favorite</i>
  <input class="mdc-text-field__input" id="menu" name="practice_wish_title">
...
<div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
  <i class="material-icons mdc-text-field__icon">favorite</i>
  <textarea rows="10" cols="5" class="mdc-text-field__input" name="practice_wish_description" placeholder="Enter Upcoming Events"></textarea>
  <div class="mdc-notched-outline">
    <div class="mdc-notched-outline__leading"></div>
    <div class="mdc-notched-outline__notch">
