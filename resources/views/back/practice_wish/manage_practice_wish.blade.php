...
<div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Manage School News</h6>
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php $i = 0 ?>
                        @foreach($practice_wish_message as $practice_wishs)
                        <tr>
                          <td>{{ ++$i }}</td>
                          <td>{{ $practice_wishs->practice_wish_title }}</td>
                          <td>{{ $practice_wishs->practice_wish_description }}</td>
                          <td>
